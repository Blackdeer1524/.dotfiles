...
vim.api.nvim_create_user_command('DapLoadLaunchJSON',
    function() require('dap.ext.vscode').load_launchjs(nil, { cppdbg = { 'c', 'cpp' } }) end, { nargs = 0 })

vim.api.nvim_create_autocmd({ "VimEnter" }, {
    callback = function() vim.cmd("DapLoadLaunchJSON") end, }
)
...
vim.keymap.set('n', '<leader>db', persisten_breakpoints.toggle_breakpoint,
...
vim.keymap.set("n", "<leader>dC", require('persistent-breakpoints.api').clear_all_breakpoints,
