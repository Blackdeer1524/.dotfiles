...
mason_lspconfig.setup_handlers {
    ...
    ["pyright"] = function()
        lspconfig.pyright.setup({
            root_dir = lsputil.root_pattern('.git', "pyrightconfig.json", '.venv', 'venv', 'README.md', 'Pipfile',
                "pyproject.toml"),
            capabilities = capabilities,
            on_attach = function(client, bufnr)
                on_attach(client, bufnr)
        ...
        lspconfig.clangd.setup {
            root_dir = function(fname)
                return lsputil.root_pattern(
                    ...
                    "meson_options.txt",
                    "build.ninja"
                )(fname) or lsputil.root_pattern("compile_commands.json", "compile_flags.txt")(
                    fname
    ...
    ["tailwindcss"] = function()
        lspconfig.tailwindcss.setup {
            root_dir = lsputil.root_pattern('tailwind.config.js', 'tailwind.config.cjs', 'tailwind.config.mjs', 'tailwind.config.ts', 'postcss.config.js', 'postcss.config.cjs', 'postcss.config.mjs', 'postcss.config.ts', 'package.json', 'node_modules', '.git'),
            capabilities = capabilities,
            on_attach = on_attach,
