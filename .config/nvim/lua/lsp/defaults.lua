...
M.on_attach = function(client, bufnr)
	...
	nmap("gd", function()
		require("telescope.builtin").lsp_definitions(telescope_search_layout)
	end, "[G]oto [D]efinition")
	nmap("gr", function()
		require("telescope.builtin").lsp_references(telescope_search_layout)
	end, "[G]oto [R]eferences")
	nmap("gI", function()
		require("telescope.builtin").lsp_implementations(telescope_search_layout)
	end, "[G]oto [I]mplementation")

	nmap("<leader>oc", function()
		require("telescope.builtin").lsp_outgoing_calls(telescope_search_layout)
	end, "LSP [o]utgoing [c]alls")
	nmap("<leader>ic", function()
		require("telescope.builtin").lsp_incoming_calls(telescope_search_layout)
	end, "LSP incoming [c]alls")

	nmap("<leader>D", function()
		require("telescope.builtin").lsp_type_definitions(telescope_search_layout)
	end, "Type [D]efinition")
	nmap("<leader>ws", function()
		require("telescope.builtin").lsp_dynamic_workspace_symbols(telescope_search_layout)
